...
const TrackOrderInputPage: React.FC = () => {
    ...
    const { getOrderByTrackingId, getOrdersByPhone } = useOrders();
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const orderById = getOrderByTrackingId(trimmedInput);
        if (orderById) {
            navigate(`/track/${orderById.trackingId}`);
            return;
        }
        ...
        // If no order found
        setError('No order found with that Tracking ID or Phone Number. Please check your details and try again.');
    }
    ...
    return (
        <div className="container mx-auto px-6 py-20 text-center min-h-[50vh] flex flex-col justify-center items-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-dark-subtext">Enter your tracking ID or phone number below to see the status of your delivery.</p>
