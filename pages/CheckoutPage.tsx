                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <label htmlFor="phone" className="block text-sm font-medium text-gray-700 dark:text-dark-subtext">Phone Number (for tracking & M-Pesa)</label>
                                    <input type="tel" name="phone" id="phone" required value={clientDetails.phone} onChange={handleChange} className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-brand-secondary focus:border-brand-secondary p-2 dark:bg-dark-card dark:border-dark-border dark:text-dark-text" />
                                </div>
                            </div>
                        </div>
