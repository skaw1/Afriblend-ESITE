    ...
    <footer className="bg-brand-primary dark:bg-dark-card text-brand-bg dark:text-dark-text">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-serif font-bold mb-4">Afriblend</h3>
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 dark:text-dark-subtext mb-2">Join our newsletter for exclusive offers and new arrivals.</p>
            <form className="flex">
